...
DATASETS_PATH = os.path.expanduser('../lenet5/data')


def fashionMNIST_loader(batch_size, *, resize=None) -> Tuple[DataLoader[list[Tensor, Tensor]], DataLoader[list[Tensor, Tensor]]]:
